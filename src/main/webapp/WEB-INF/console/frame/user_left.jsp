...
<%@ include file="../date.jsp" %>
     <ul class="w-lful">
		<li><a href="<%=basePath%>/user/list.do" target="rightFrame">用户管理</a></li>
		<li><a href="<%=basePath%>/doctor/list.do" target="rightFrame">医生管理</a></li>
		<li><a href="<%=basePath%>/hospital/list.do" target="rightFrame">医院管理</a></li>
		<li><a href="<%=basePath%>/pharmacy/list.do" target="rightFrame">药房管理</a></li>  
