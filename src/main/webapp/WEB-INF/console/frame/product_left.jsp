...
<%@ include file="../date.jsp" %>
     <ul class="w-lful">
		<li><a href="<%=basePath%>/product/list.do" target="rightFrame">商品管理</a></li>
		<li><a href="<%=basePath%>/brand/list.do" target="rightFrame">品牌管理</a></li>
		<li><a href="<%=basePath%>/factory/list.do" target="rightFrame">厂家管理</a></li> 
		<!--  
