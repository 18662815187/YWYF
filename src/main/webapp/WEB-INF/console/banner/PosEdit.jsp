...
<body>
	...
	<div class="body-box" style="float: right">
		<form id="jvForm" action="<%=basePath%>/posstion/saveOrUpdate" method="post"
			enctype="multipart/form-data">
			<input type="hidden" value="${bannerPosition.id}" name="id" />
			<table cellspacing="1" cellpadding="2" width="100%" border="0"
				class="pn-ftable">
				<tbody>
					<tr>
						<td width="20%" class="pn-flabel pn-flabel-h"><span
							class="pn-frequired">*</span> 位置名称:</td>
						<td width="80%" class="pn-fcontent"><input type="text"
							class="required" name="position" value="${bannerPosition.position}"
							maxlength="100" /></td>
					</tr>
				</tbody>
				<tbody>
